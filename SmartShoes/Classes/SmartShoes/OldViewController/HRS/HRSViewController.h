...
@protocol HRSViewControllerDelegate;
...
@property (strong, nonatomic) id<HRSViewControllerDelegate> delegate;
...
@protocol HRSViewControllerDelegate <NSObject>

-(void)scannerData:(CBCentralManager*) manager didPeripheralSelected:(CBPeripheral*) peripheral;
